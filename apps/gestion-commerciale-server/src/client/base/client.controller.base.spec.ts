...
const CREATE_INPUT = {
  ...
  createdAt: new Date(),
  dateDinscription: new Date(),
  email: "exampleEmail",
  entreprise: "exampleEntreprise",
  id: "exampleId",
  nom: "exampleNom",
  ...
  test("POST /clients", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateDinscription: CREATE_RESULT.dateDinscription.toISOString(),
      ...
      .expect([
        {
          ...
          dateDinscription: FIND_MANY_RESULT[0].dateDinscription.toISOString(),
  ...
  test("GET /clients/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dateDinscription: FIND_ONE_RESULT.dateDinscription.toISOString(),
